...
<body>
    ...
    <div class="bottom" style="background-color: #023047; display: flex; flex-direction: column; justify-content: flex-start; align-items: center;">
        ...
        <div class="mid" style="color: white; margin: -175px 0px -750px 0px; display: flex; flex-direction: column; justify-content: center; align-items: flex-start;">
        ...
        <div class="curved-section-top">
            <h1 style="width: 70vw; text-align: center; padding: 650px 0px 50px 0px;">Mengapa Peran Anda Penting?</h1>
            <div class="row justify-content-center g-4">
                <div class="col-sm-12 col-lg-3" style="background-color: #FFFBF0; margin: 25px;">
                    <div class="p-3">
